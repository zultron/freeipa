...
/* #undef HAVE_KDB_FREEPRINCIPAL */

/* KDB driver API has free_principal_e_data callback */
#define HAVE_KDB_FREEPRINCIPAL_EDATA 1

/* MIT Kerberos version supports certauth plugin */
#define HAVE_KRB5_CERTAUTH_PLUGIN 1

/* Define to 1 if you have the <memory.h> header file. */
#define HAVE_MEMORY_H 1

/* Ability to enumerate UPN suffixes */
#define HAVE_PDB_ENUM_UPN_SUFFIXES 1

/* Define to 1 if you have the <setjmp.h> header file. */
#define HAVE_SETJMP_H 1

/* struct smbldap_state is opaque */
#define HAVE_SMBLDAP_GET_LDAP 1

/* struct smbldap_state is opaque */
#define HAVE_SMBLDAP_SET_BIND_CALLBACK 1
...
#define HAVE_STRUCT_PAC_DOMAIN_GROUP_MEMBERSHIP 1
