...
DIST_SUBDIRS = asn1 util client contrib po pypi ipaclient ipalib \
	ipapython ipaplatform ipatests daemons init install ipaserver
...
ACLOCAL = ${SHELL} /home/jman/git/freeipa-deps/freeipa/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
API_VERSION = 2.229
AR = ar
AUTOCONF = ${SHELL} /home/jman/git/freeipa-deps/freeipa/missing autoconf
AUTOHEADER = ${SHELL} /home/jman/git/freeipa-deps/freeipa/missing autoheader
AUTOMAKE = ${SHELL} /home/jman/git/freeipa-deps/freeipa/missing automake-1.15
AWK = gawk
CC = gcc
...
INTL_MACOSX_LIBS = 
IPAPLATFORM = fedora
IPA_DATA_DIR = /usr/share/ipa
IPA_SYSCONF_DIR = /etc/ipa
JSLINT = /usr/bin/jsl
KRAD_LIBS = -lkrad
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/jman/git/freeipa-deps/freeipa/missing makeinfo
MANIFEST_TOOL = :
...
abs_builddir = /home/jman/git/freeipa-deps/freeipa
abs_srcdir = /home/jman/git/freeipa-deps/freeipa
abs_top_builddir = /home/jman/git/freeipa-deps/freeipa
abs_top_srcdir = /home/jman/git/freeipa-deps/freeipa
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/jman/git/freeipa-deps/freeipa/install-sh
...
ifeq ($(IPA_SERVER_WHEELS),1)
    IPA_WHEEL_PACKAGES = $(IPACLIENT_SUBDIRS) ipaplatform ipaserver
    IPA_OMIT_INSTALL = 0
else
    IPA_WHEEL_PACKAGES = $(IPACLIENT_SUBDIRS)
    IPA_OMIT_INSTALL = 1
endif
